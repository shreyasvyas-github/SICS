...
class Bill_App:
    def __init__(self,root):
        ...
        cphn_txt = Entry(F1, width=20,textvariable=self.c_mail, font="arial 15", bd=7, relief=SUNKEN).grid(row=0, column=3, pady=5, padx=10)
    ...
    def save_bill(self):
        ...
        if op>0:
          ...
          messagebox.askyesno("Send Mail",f"Bill No.:{self.bill_no.get()}?")
          self.e_mail()
    ...
    def e_mail(self):
        ...
        filename = ("C:/Users/DELL/PycharmProjects/IMS/myQR.png")
